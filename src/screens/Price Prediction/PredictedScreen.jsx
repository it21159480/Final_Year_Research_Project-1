...
import { PRICE_PREDICTION_SCREEN } from './PricePredictionScreen';

export const PREDICTED_SCREEN = 'PREDICTED_SCREEN';

function PredictedScreen({ route, navigation }) {
  const { riceType, predictions } = route.params;

  const handleNavigate = () => {
    // Navigate to PricePredictedScreen when the button is pressed
